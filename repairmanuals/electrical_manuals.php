...
<body>
    ...
    <main>
        <section class="main-content">
            <h2>Elecrical Repair Manuals</h2>

            <!-- Search Bar Section -->
            <div class="search-container">
                <!-- Search form that will handle redirection -->
                <form id="search-form" action="manual_detail_ele.php" method="GET">
                    <input type="text" id="search-bar" name="query" class="search-bar" placeholder="Search Elecrical Manuals..." onkeyup="searchManuals()">
