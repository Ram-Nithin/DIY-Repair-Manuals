...
if ($query) {
    ...
    $sql = "SELECT * FROM plumbing_manuals WHERE problem_name LIKE ?";
...
@media (max-width: 768px) {
    ...
    .header .button-container {
        ...
        .manual-detail .solution-title {
            ...
            .solution p {
        margin: 0; /* Removes any extra margin from paragraphs */
...
<body>
    ...
    <header>
        ...
        <div class="button-container">
            ...
            <a href="plumbing_manuals.php" class="header-button">Back to Plumbing Manuals</a>
        </div>
    </header>
                ...
                <?php foreach ($manuals as $manual): ?>
                    <div class="manual-detail">
                        <div class="problem-name">
                            <?php echo htmlspecialchars($manual['problem_name']); ?>
                        </div>
                        <div class="details">
